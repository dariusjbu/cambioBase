...
m222=m122*(1/tB)-246*0.5*(l2*sB2+(l3+l4+l5)*cB2+l6*cB2*(1/tB)+3*l7*np.sqrt(sB2*cB2))

#M222 = m112*sB2+m222*cB2+m122*c2B

M222=m112*sB2+m222*cB2+m122*s2B

#L3=(l1+l2+2*l4+l5)*cB2*sB2*0.5+(cB2*cB2+sB2*sB2)*l3*0.25+(l6+l7)*s2B*c2B*c2B*0.125
